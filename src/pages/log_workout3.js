      ...
      <div className='fullwidth'>
        <div className='imagebox2'>
          <div className='innerbox'>
              ...
              <div className='boxbox'>
              <div className='shadingbox'></div>
              <div className = 'textbox'>Box 2</div>
            </div>
    ...
    <div className='fullwidth'>
      <div className='banner'>
        <div className='bannerinnerbox'>
            ...
            <div className = 'bannertextbox'>Set 1: 2 rounds</div>
          </div>
    ...
    <div className='mytopimage'>
      ...
      <span className='myimagebutton'>
        <Typography className='myimagetitle'>
          <span className='mytopimagemarked'>The Log within you</span>
        </Typography>
        ...
        <Typography className='myimagetitle'>
          <span className='myimagemarked'>
            <table className='setTable'>
             <tr>
               <div className='th1'>Workout for {this.state.workout_date}:   {this.state.workout_name}</div> </tr>
               <tr>
                   <th>Set 1: </th> </tr>
                   <tr>
      ...
      <Typography className='myimagetitle'>
        <span className='myimagemarked2'>
          ...
          <table className='setTable'>
           ...
           <Paper className="paper" style={{marginTop: '0px',  maxWidth: '1000px'}}>
